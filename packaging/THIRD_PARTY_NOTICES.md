...
当前构建包含 Python、PySide6/Qt、Shiboken、Pillow、NumPy、mss、windows-capture/OpenCV、PyWinRT、httpx、websockets、qrcode 及其锁定依赖。精确 Python 包版本见 `uv.lock`，本机探测版本见 `docs/acceptance/2026-09-05-refactor.md`。
